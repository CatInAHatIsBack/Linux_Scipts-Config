...
awful.util.tagnames = { "console", "code", "web", "music", "key5", "key6" }
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "F8", function () awful.util.spawn( "inkscape" ) end,
    ...
    awful.key({ modkey , "Shift" }, "d", function () awful.util.spawn( "rofi-theme-selector" ) end,
...
-- super + shift + ...
    awful.key({ modkey }, "m", function() awful.util.spawn( emacs ) end),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    -- -- Layout manipulation                   chaning  to global and bydirection
